...
\usepackage{enumitem}                                                   % Alpha numeric enumerations
\usepackage{framed}                                                     % Provides borders around things
\usepackage{soul}                                                       % Provides strike-through text
%---------------------------------------------------------------------------

% Definition of Colors
%---------------------------------------------------------------------------
\RequirePackage{xcolor}                                                  % Color (not xcolor! why?)
...
\usepackage[
    ...
    pdfauthor = {gunzm1},                                                 % PDF-property
    pdfsubject = {Aufbau von Wissensdomänen anhand einer semantischen Datenbank},                                      % PDF-property
...
\externaldocument[THESIS-]{../Thesis/template}
%---------------------------------------------------------------------------
...
\include{kapitel/experten_systeme}
\include{kapitel/graph_data}
\include{kapitel/semantische_netze}
\include{kapitel/ontologien}
\include{kapitel/inferenz_und_resolution}
\include{kapitel/rdf}
\include{kapitel/owl}
\include{kapitel/swrl}
\include{kapitel/sparql}
