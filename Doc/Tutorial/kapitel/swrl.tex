...
Eine Regel kann in SWRL keine ODER-Verknüpfung enthalten, wie in~\autoref{sec:swrl_aufbau} (\nameref{sec:swrl_aufbau}) beschrieben. Die ODER-Verknüpfungen bildet man ab, durch mehrfache Definition derselben Regel. Der Regelkopf (das heisst die Schlussfolgerung) muss immer gleich sein, die Bedingungen (das heisst die Regelköper) dürfen verschieden sein.
