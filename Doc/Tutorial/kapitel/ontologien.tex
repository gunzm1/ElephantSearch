...
Ontolgien werden in Basis-, Domänen- und Brücken-Ontologien unterteilt. ``Basis-Ontologien (Foundational Ontologies) sind domänenübergreifende Ontologie-Schemata mit allgemeinen Begriffen wie physisches Objekt, Eigenschaft oder Bereich.''~\cite[S. 291]{IspekOntoBedeutung}. Domänen-Ontologien bauen auf Basis-Ontologien auf und richten sich auf ihren Verwendungszweck aus. ``Zur Verbindung unterschiedlicher Basis-Ontologien werden sogenannte Brücken-Ontologien entwickelt.''~\cite[S. 291-292]{IspekOntoBedeutung}

\begin{figure}[H]
\centering \rotatebox{0}{\scalebox{0.5}[0.5]{\includegraphics{bilder/ontoStruk.png}}}
\caption{Ontologiestruktur\label{fig:ontoStruk}\protect\footnotemark}
\end{figure}
\footnotetext{~\cite[S. 292]{IspekOntoBedeutung}}
...
Die Aufgabe von Ontologien ist die Ermöglichung und Verbesserung von Kommunikation zwischen Computeranwendungen untereinander und zwischen Computeranwendungen und Mensch.\\
...
\end{wrapfigure}
Wir brauchen Ontologien. Dabei spielt die Wahl der Domäne eine grosse Rolle. Bei unserer Wissensmodellierung haben wir gelernt, dass sich nicht jeder Themenbereich als Domäne eignet.
