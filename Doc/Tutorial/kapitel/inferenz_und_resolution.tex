...
\begin{lstlisting}[caption={Definition Interpretation \protect\footnotemark}]
...
\begin{lstlisting}[caption={Äquivalenz von semantischer Folgerung und Widerspruchsbeweis\protect\footnotemark}]
...
Die Beschreibung des Tableau-Kalküles basiert, sofern nicht anders vermerkt, auf~\cite{baumkalkuel}.
...
\begin{figure}[htbp]
    ...
    \caption{Wurzelknoten des Graphen}
\end{figure}
