...
\begin{textblock}{154}[0,-0.2](28,50)
    \centering
    \includegraphics[scale=0.7]{bilder/ElephantTitel.png}   % Titelbild definieren
\end{textblock}
...
\textbf{Anforderungsdokument der Bachelorthesis} \\                                 % eingeben
\vspace{3mm}
...
Betreuer:   \> Dr.~Jürgen Eckerle       \\                  % Namen eingeben
