...
\include{kapitel/administratives}
\include{kapitel/aufgabenstellung}
\include{kapitel/vorgehen}
\include{kapitel/loesung}
\include{kapitel/komponenten}
\include{kapitel/fazit}
%\include{kapitel/schlussbemerkung}
%---------------------------------------------------------------------------
...
\include{anhang/schnipsel}
\includepdf[pages=-, addtotoc={1,chapter,0,Tutorial Wissensmodellierung,chap:tutorial},scale=0.9]{anhang/Tutorial.pdf}
\includepdf[pages=-, addtotoc={1,chapter,0,Dokumentation Projekt 2,chap:tutorial},scale=0.9]{anhang/DokumentationProjekt2.pdf}
\include{anhang/benutzerhandbuch}
\includepdf[pages=-, addtotoc={1,chapter,0,Arbeitsjournal ,chap:arbeitsjournal},scale=0.9]{anhang/Journal.pdf}
%\include{anhang/Arbeitsjournal}
\include{anhang/modellierung}
%---------------------------------------------------------------------------
