...
Um Abweichungen von den gesteckten Zielen und eine Entwicklung in die falsche Richtung der Arbeit zu vermeiden, wurden regelmässige Treffen mit dem Betreuer der Arbeit abgehalten. Ein Treffen zwische den Autoren der Arbeit und dem Betreuer wurde im Minium alle zwei Wochen abgehalten.
...
\begin{figure}[H]
    \begin{ganttchart}[
        ...
        \ganttbar{Erarbeitung Grundlagen}{3}{4} \\
...
In dieser ersten Phase wurden die Meilensteine der Arbeit identifiziert und grob beschrieben. Da ein gewisses Vorwissen hinlänglich semantischen Datenbanken notwendig ist, um die Aufgaben dieser Arbeit zu verstehen, wurde dieses erarbeitet. Zudem wurde das Grundgerüst dieser Dokumentation gelegt.
...
An dieser Stelle wurden  die Unterschiede der eingesetzten Anwendung zum Ziehen von Schlüssen (Pellet) bzw.\ der Mächtigkeit der Regeln gegenüber Prolog ersichtlich. 
Prolog ist hinsichtlich dieser Faktoren sehr flexibel. So ist man bei der Definition von Regeln nicht eingeschränkt, wobei diese beliebig viele Fakten und Prädikate enthalten können.
...
Mit der Erstellung der abschliessenden Dokumentation ist das hier vorliegende Dokument gemeint. Dieses wurde während der ganzen Projektarbeit stetig erweitert, auch um die bereits fertiggestellten Arbeitn zu reflektieren.
